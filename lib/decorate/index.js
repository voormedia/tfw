...
const add_headers_1 = require("../middleware/add-headers");
...
function addHeaders(headers = {}) {
    return (0, use_1.use)((0, add_headers_1.default)(headers));
}
