...
describe("parse body", function() {
  ...
  describe("with bad content type", function() {
    ...
    it("should render error", function() {
      assert.equal(this.body, '{"error":"Bad request","message":"Bad Content-Type header"}')
    })
  ...
  describe("with bad charset", function() {
    ...
    it("should render error", function() {
      assert.equal(this.body, '{"error":"Unsupported media type","message":"Charset utf-16 is not supported"}')
    })
  ...
  describe("with bad json", function() {
    ...
    it("should render error", function() {
      assert.equal(this.body, '{"error":"Bad request","message":"Unexpected token f in JSON at position 1"}')
    })
